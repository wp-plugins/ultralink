...
//        wp_register_script('ultralink', plugins_url('ultralink.js', __FILE__), array('jquery', 'jquery-ui-core', 'jquery-ui-dialog', 'raphael'));
        wp_register_script('ultralink', plugins_url('ultralink.js', __FILE__), array('jquery', 'raphael'));
        wp_enqueue_script('ultralink');
        
//        wp_register_style('jquery-ui-dialog', plugins_url('ultralinkLibraries/jquery-ui.css', __FILE__));
...
//							{
//								$wpdb->query("INSERT INTO " . $dbPrefix . "ultralink_changed_content" . " (permalink, more, page) VALUES( '" . $wpdb->escape($plink) . "', '" . $more . "', '" . $page . "')");								
//							}
//                            
...
function saveSettings()
{
    ...
    $source                = $wpdb->escape($_POST['ultralink_source']);
    
    $defaultSearch = $wpdb->escape($_POST['ultralink_defaultSearch']);
